...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AppSpectorSDK",
            //url: "https://storage.googleapis.com/appspector-spm/1.4.0/AppSpectorSDK-1.4.0.xcframework.zip",
        ...
        .binaryTarget(
            name: "AppSpectorTVSDK",
            //url: "https://storage.googleapis.com/appspector-spm/1.4.0/AppSpectorTVSDK-1.4.0.xcframework.zip",
